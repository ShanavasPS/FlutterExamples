      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Time: ${context.watch<TimerProvider>().countdown.toString()} Seconds',
            ...
            ElevatedButton(
              ...
              onPressed: context.watch<TimerProvider>().isActive
                  ? context.read<TimerProvider>().stop
                  : context.read<TimerProvider>().startCountdown,
              child: Text(context.watch<TimerProvider>().isActive ? 'Stop' : 'Start'),
            ),
          ],
        ),
      ),
